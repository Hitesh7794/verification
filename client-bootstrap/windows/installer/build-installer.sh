...
#      client-bootstrap/windows/dist/VerificationPortalClient-1.1.1-windows/
#
# Output:
#   client-bootstrap/windows/installer/output/OperatorPortalSetup-1.1.1.exe
#
...
BUNDLE_DIR="${WINDOWS_DIR}/dist/VerificationPortalClient-1.1.1-windows"
...
OUT="$INSTALLER_DIR/output/OperatorPortalSetup-1.1.1.exe"
if [ ! -f "$OUT" ]; then
