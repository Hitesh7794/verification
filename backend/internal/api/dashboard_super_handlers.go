...
func (s *Server) superStats(w http.ResponseWriter, r *http.Request) {
	...
	// Exclude system-baked superadmin(s) from the "Operators & Staff"
	// count so a freshly-wiped DB doesn't read "1" for the seed super
	// account. (ops_admin used to be excluded too — role retired
	// 2026-08-27.)
