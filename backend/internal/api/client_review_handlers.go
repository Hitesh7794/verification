...
//
// The single-item list/get/approve/reject/docs endpoints now live in
// reverse_proxy_kyc.go — they reverse-proxy up to the Control Plane
// which owns institution_applications. This file keeps the bulk
// approve/reject variants, subscription-request management, and
// client-reviewer exam management, which still act on DP-local state.
