      ...
      <FadeIn>
        ...
        {completeness && completeness.total > 0 && (
          <div className="mb-4 rounded-xl border border-warm bg-warm-surface p-4 shadow-sm">
            ...
            {/* Three tiles only — Photo / FP template / Iris. FP image
                was dropped 2026-09-07 to match the superadmin view;
                matching runs on the FP template, and showing an
                enrolment tile for the raw image confused reviewers
