...
//   3. Candidate data     — TrustView ref
//
// Creation deliberately does NOT take a candidate CSV. The roster is
// uploaded from the exam page once the exam exists, which is also where
// upload history and per-row validation errors live — one place to do it,
// one place to see what happened. The create endpoint is JSON-only and
// never accepted a file; the CSV always went to a separate endpoint.
    ...
    <div className="mb-6 rounded-xl bg-white ring-1 ring-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="p-5 sm:p-6">
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <FormSection num="3" title="Candidate data" hint="Optional. The roster is uploaded separately, from the exam page.">
            <div>
              ...
              <p className="text-[11px] text-slate-500 mt-1.5">
                Candidates and centres are added from the exam page after this
                exam is created.
              </p>
            </div>
          </FormSection>
