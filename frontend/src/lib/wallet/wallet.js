...
export async function getWallet({ before } = {}) {
...
// {error, balance_paise, fee_paise} in the body when balance is too
// low. The client Dashboard uses isWalletEmptyError() from lib/api.js
// to detect the 402 and surface a "wallet empty — contact admin"
// banner; this helper is kept for future callers that want richer
// information from the parsed body.
